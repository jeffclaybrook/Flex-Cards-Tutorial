function createMiniCards() {
 ...
 const cards = data.map(item => {
  ...
  return `
   <div class="mini-card">
    <div class="mini-card-icon" style="background: ${background}">
...
function createBaseCards() {
 ...
 const container = document.querySelector(".base-cards")
 const cards = data.map(item => {
...
function createHorzCards() {
 ...
 const container = document.querySelector(".horz-cards")
 const cards = data.map(item => {
